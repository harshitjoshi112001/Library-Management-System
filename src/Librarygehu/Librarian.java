...
public class Librarian extends JFrame implements ActionListener{
    ...
    Librarian()
    {
        ...
        JLabel heading=new JLabel("Librarian Login");
        heading.setBounds(143,7,200,27);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == login)
        {
            try
            {
              ...
              String s="select name,password from librarian1 where name='"+name+"' and password='"+pass+"'";
